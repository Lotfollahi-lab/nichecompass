...
def compute_per_cell_log_rclisi(
    ...
    cell-type heterogeneity score (RCLISI) as proposed in Heidari, E. et al. 
...
def _compute_per_cell_clisi_from_feature(
    ...
    an AnnData object. The per-cell CLISI captures the degree of cell mixing 
...
def _compute_per_cell_clisi(
    ...
    """
    Compute per-cell Cell-Type Local Inverse Simpson's Index (CLISI) from a 
